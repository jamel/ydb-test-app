...
import org.jamel.exceptions.NonRetriableErrorException;
import org.jamel.exceptions.TooManyRetriesException;
 ...
 */
public class BasicExampleV1 implements AutoCloseable {
    ...
    BasicExampleV1(@WillClose RpcTransport transport, String database) {
        this.database = database;
        this.tableClient = TableClient.newClient(GrpcTableRpc.ownTransport(transport))
            .build();
